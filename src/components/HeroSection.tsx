      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
        ...
        >
          ...
          <button
            ...
            className="px-8 py-4 border-2 border-secondary-foreground/30 hover:border-primary text-secondary-foreground hover:text-primary font-medium rounded-full transition-all"
          >
            Kërko Poezi
          </button>
        </motion.div>
        ...
        >
          <div className="w-6 h-10 rounded-full border-2 border-secondary-foreground/30 flex items-start justify-center p-2">
            <div className="w-1 h-2 bg-secondary-foreground/50 rounded-full animate-bounce" />
          </div>
        </motion.div>
      </div>
    </section>
