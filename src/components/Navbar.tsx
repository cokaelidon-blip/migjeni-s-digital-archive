      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <button
            ...
            className="hidden md:flex items-center justify-center w-10 h-10 rounded-full bg-secondary-foreground/10 hover:bg-primary transition-all group"
          >
            ...
            >
              {links.map((link) => (
                <a
                  ...
                  className="block text-secondary-foreground/90 hover:text-primary py-2"
                >
                  {link.label}
                </a>
              ))}
