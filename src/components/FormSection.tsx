...
const FormSection = () => {
  const formUrl =
    "https://docs.google.com/forms/d/e/1FAIpQLSfQL1Kt9lhKvj-rhRuGvDqqQz9QODPolZrZFXmt2AicfTFntw/viewform?usp=publish-editor";

  return (
    <section id="formulari" className="py-24 bg-background">
